...
quantile_vegas = pd.read_parquet(r"C:\Users\pablo.esparcia\Documents\OptionMetrics\output\time_series\quantile_vega.parquet").set_index("Date")

print(quantile_vegas.describe())
...
for quantile in quantile_vegas.columns:
    result = adfuller(quantile_vegas[quantile], regression="ctt")
...
#3) Ploteo de nuevo como en vega_graph_1 pero para la diferencia:
