...
quantile_deltas = pd.read_parquet(r"C:\Users\pablo.esparcia\Documents\OptionMetrics\output\time_series\quantile_delta_full.parquet").set_index("Date")

print(quantile_deltas.describe())
...
for quantile in quantile_deltas.columns:
    result = adfuller(quantile_deltas[quantile], regression="ctt")
...
#3) Ploteo de nuevo como en delta_graph_1 pero para la diferencia:
